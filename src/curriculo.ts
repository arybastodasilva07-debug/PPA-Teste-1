export const curriculo: Record<string, any> = {
    ...
    "1ª Classe": {
        ...
        "Matemática": {
            "TEMA 1 – GEOMETRIA": {
                "Geral": [
                    "Relações espaciais(À frente/atrás/entre; Em cima/em baixo; dentro/fora; Interior/Exterior; Alto/baixo; Direita/esquerda/à direita/à esquerda)",
                    "Sólidos geométricos",
        ...
        "Matemática": {
            ...
            "Números e Operações": {
                "Geral": [
                    ...
                    "Resolução de problemas envolvendo números naturais de 500 até 1 000"
                ]
            },
            "Grandezas e Medidas": {
                "Geral": [
